...
class Record(Base):
    ...
    dept_of_action_judgement = Column(String, nullable=True)   # MQ department of investigator
    judgement_date = Column(String, nullable=True)             # Decision date by investigator
    reason_not_sbpr = Column(String, nullable=True)            # Justification for not filing SBPR
