...
import importlib
for mod in ["auth.session", "core.singletons", "core.router", "core.paths", "viz.charts", "reports.engine", "analytics.engine", "analytics.graph_selector", "nlp.pipeline", "llm.client"]:
...
from ui.theme import inject_design_system, render_app_header
