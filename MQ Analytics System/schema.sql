...
CREATE TABLE IF NOT EXISTS records (
    ...
    department_of_action_judgement TEXT,      -- MQ department of the action judgement person
    judgement_date TEXT,                -- Date decision was made by person of action judgement
    reason_of_not_to_file_as_an_sbpr TEXT,               -- Justification for closing FTIR without filing as SBPR
